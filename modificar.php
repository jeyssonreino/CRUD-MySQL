...
if (isset($_POST['id'])) {
    ...
    if ($can == 1) {
        while ($lista = $existe->fetch_assoc()) {
            ...
            echo "<input id='apellido' name='apellido' type='text' required='required' class='form-control col-3' value=" . $lista["apellido"] . "><br>";
            echo "<input id='telefono' name='telefono' type='text' required='required' class='form-control col-3' value=" . $lista["tel"] . "><br>";
